...
/**
 * ⚠ A COPY of `ai-visual.ts` for `AiSectionNext`, the next candidate at `/internal/sections/ai/`.
 * Edit the content HERE; the homepage keeps reading `ai-visual.ts`. Made 2026-09-24.
 *
...
export const AI_COLUMNS: { assistant: AiColumn; cli: AiColumn } = {
	assistant: {
		...
		// The switch names WHO does the work, as the value copy's does (2026-09-24, on request); the
		// eyebrow stays for the `bands` layout.
...
/**
 * THE TERMINAL RUNS A CODING AGENT, not a shell — the change this copy is for (2026-09-24).
 *
